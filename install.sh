...
if  "$resposta" = '1' ; then
    ...
    wget -P $_Ink https://raw.githubusercontent.com/zaw-my-script/zaw1995-ssh-script/main/install.sh/list >/dev/null 2>&1
    verif_key
    sleep 3s
    echo "/bin/menu" >/bin/h && chmod +x /bin/h >/dev/null 2>&1
    rm versao* >/dev/null 2>&1
    wget https://raw.githubusercontent.com/zaw-my-script/zaw1995-ssh-script/main/install.sh/versao >/dev/null 2>&1
    >/dev/null 2>&1
    ...
    wget https://raw.githubusercontent.com/zaw-my-script/zaw1995-ssh-script/main/install.sh/Modulos/v2raymanager >/dev/null 2>&1
    ...
    cd $HOME/BOT
    wget https://raw.githubusercontent.com/zaw-my-script/zaw1995-ssh-script/main/install.sh/Sistema/ShellBot.sh >/dev/null 2>&1
